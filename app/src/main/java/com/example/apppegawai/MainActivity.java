    ...
    private void showEmployee() {
        ...
        try {
            ...
            for (int i = 0; i<result.length(); i++){
                ...
                String name = jo.getString(Connection.TAG_NAME);
                HashMap<String,String> employees = new HashMap<>();
                employees.put(Connection.TAG_ID,id);
                employees.put(Connection.TAG_NAME,name);
                list.add(employees);
        ...
        SimpleAdapter adapter = new SimpleAdapter(this,list,
                R.layout.list_item,
                new String[]{Connection.TAG_ID,Connection.TAG_NAME},
